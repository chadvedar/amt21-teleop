...
def compute_jacobian(T):
    ...
    th1, th2, th3, th4, th5, th6 = sp.symbols('theta1, theta2, theta3, theta4, theta5, theta6')

    J = sp.Matrix([
        [sp.diff(x, th1), sp.diff(x, th2), sp.diff(x, th3), sp.diff(x, th4), sp.diff(x, th5), sp.diff(x, th6)],
        [sp.diff(y, th1), sp.diff(y, th2), sp.diff(y, th3), sp.diff(y, th4), sp.diff(y, th5), sp.diff(y, th6)],
        [sp.diff(z, th1), sp.diff(z, th2), sp.diff(z, th3), sp.diff(z, th4), sp.diff(z, th5), sp.diff(z, th6)]
    ])
